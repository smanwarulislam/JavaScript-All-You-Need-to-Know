...
/* We see two types of inheritance:
1. Classical inheritance - Where class-based object-oriented languages inherit
2. Prototypical inheritance - Where there is a language like JavaScript, where there is no class, we can inherit */
